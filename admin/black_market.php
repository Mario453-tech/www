...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && CSRF::validateToken($_POST['csrf_token'] ?? '')) {
    ...
    if ($action === 'update_config') {
        $configKeys = [
            ...
            'bm_score_per_pln', 'bm_decay_pct', 'bm_decay_interval_hours', 'bm_sabotage_threshold',
        ];
        $stmt = $db->prepare("
...
$cfgKeys = [
    ...
    'bm_score_per_pln' => 0.0, 'bm_decay_pct' => 0.0,
    'bm_decay_interval_hours' => 24.0, 'bm_sabotage_threshold' => 30.0,
];
try {
...
$cfgLabels = [
    ...
    'bm_score_per_pln'         => t('black_market.cfg_score_per_pln'),
    'bm_decay_pct'             => t('black_market.cfg_decay_pct'),
    'bm_decay_interval_hours'  => t('black_market.cfg_decay_interval_hours'),
    'bm_sabotage_threshold'    => t('black_market.cfg_sabotage_threshold'),
];
