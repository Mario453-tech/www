...
return [
    ...
    'admin.legal.col_delay_pct_hint'=> 'Ryzyko opóźnienia decyzji (0-100%)',
    'admin.legal.col_delay_min'     => 'Opóźn. min (min)',
    'admin.legal.col_delay_max'     => 'Opóźn. max (min)',
    'admin.legal.col_refusal_pct'   => 'Ryzyko odmowy %',
    'admin.legal.col_refusal_pct_hint' => 'Ryzyko odmowy wniosku (0-100%)',
    'admin.legal.col_nodec_pct'     => 'Ryzyko braku dec. %',
    'admin.legal.col_nodec_pct_hint'=> 'Ryzyko braku decyzji (0-100%)',
