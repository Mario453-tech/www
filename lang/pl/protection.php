...
return [
    ...
    'protection.effect.disclaimer'  => 'Zmniejsza ryzyko, ale go nie eliminuje.',
    ...
    'protection.risk.equipment_damage_risk_mult'  => 'uszkodzenia sprzętu',
    'protection.risk.local_leak_risk_mult'        => 'wycieku',
    'protection.risk.critical_overload_risk_mult' => 'krytycznego przeciążenia',
    'protection.risk.transfer_failure_risk_mult'  => 'awarii przeładunku',
    'protection.risk.loading_error_risk_mult'     => 'błędu załadunku',
    'protection.risk.storage_jam_risk_mult'       => 'zatoru magazynowego',
    'protection.risk.pipeline_incident_risk_mult' => 'awarii rurociągu',

    // Walidacja celu (endpoint) / Target validation (endpoint)
    'protection.err_target_invalid'  => 'Ten cel nie istnieje lub nie należy do Ciebie.',
    ...
    'protection.target_pipeline'     => 'Rurociąg #:id',
    'protection.pipeline_target_leg'   => 'Rurociąg #:id (:leg)',
    'protection.pipeline_leg_inbound'  => 'odwiert → hub',
    'protection.pipeline_leg_outbound' => 'hub → magazyn',

    // Sekcje w logistyce / Logistics sections
    'protection.section_title_road'     => 'Ochrona transportu drogowego',
    'protection.section_desc_road'      => 'Ochrona zmniejsza ryzyko kradzieży, napadu i sabotażu kursów',
    'protection.section_title_hub'      => 'Ochrona hubów',
    'protection.section_desc_hub'       => 'Ochrona zmniejsza ryzyko uszkodzenia sprzętu, wycieku i przeciążenia huba',
    'protection.section_title_pipeline' => 'Ochrona rurociągów',
    'protection.section_desc_pipeline'  => 'Ochrona zmniejsza ryzyko awarii rurociągu',
    'protection.col_well'         => 'Odwiert',
    'protection.col_hub'          => 'Hub',
    'protection.col_pipeline'     => 'Rurociąg',
    ...
    'protection.confirm_renew'      => 'Przedłużyć ochronę ":name" za :cost PLN? Obecna ochrona zostanie anulowana bez zwrotu.',
];
