...
class HubService
{
    ...
    {
        $this->db = $db;
        $this->ensureHubSchema();
        $this->loadHubConfig();
        $this->ensureAcquisitionConfigDefaults();
    }
}
