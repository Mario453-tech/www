...
return array(
    'AbstractPrivacyFeature' => $baseDir . '/src/Privacy/AbstractPrivacyFeature.php',
    'AbstractTrainingSkill' => $baseDir . '/src/Training/AbstractTrainingSkill.php',
    'AdminAuth' => $baseDir . '/src/AdminAuth.php',
    'AdminHubConfigFieldTrait' => $baseDir . '/src/AdminHub/ConfigFieldTrait.php',
    'AdminHubDataFetchTrait' => $baseDir . '/src/AdminHub/DataFetchTrait.php',
    'AdminHubPostActionsTrait' => $baseDir . '/src/AdminHub/PostActionsTrait.php',
    'AdminLog' => $baseDir . '/src/AdminLog.php',
    'AdminNewsHtml' => $baseDir . '/src/AdminNewsHtml.php',
    'AdminPlayerDeletionService' => $baseDir . '/src/AdminPlayerDeletionService.php',
    'ApiAuth' => $baseDir . '/src/ApiAuth.php',
    'Auth' => $baseDir . '/src/Auth.php',
    'B2BContractSchema' => $baseDir . '/src/B2BContracts/B2BContractSchema.php',
    'B2BContractService' => $baseDir . '/src/B2BContractService.php',
    'B2BContractsModule' => $baseDir . '/src/Tick/Modules/B2BContractsModule.php',
    'BailiffService' => $baseDir . '/src/BailiffService.php',
    'BankAccountService' => $baseDir . '/src/BankAccountService.php',
    'BankActionsHandler' => $baseDir . '/src/Bank/ActionsHandler.php',
    'BankApplicationTrait' => $baseDir . '/src/Bank/ApplicationTrait.php',
    'BankCalculationTrait' => $baseDir . '/src/Bank/CalculationTrait.php',
    'BankDataLoader' => $baseDir . '/src/Bank/DataLoader.php',
    'BankModule' => $baseDir . '/src/Tick/Modules/BankModule.php',
    'BankNegotiationContextTrait' => $baseDir . '/src/BankNegotiation/ContextTrait.php',
    'BankNegotiationMessagesTrait' => $baseDir . '/src/BankNegotiation/MessagesTrait.php',
    'BankNegotiationProcessorTrait' => $baseDir . '/src/BankNegotiation/ProcessorTrait.php',
    'BankNegotiationRandomEventsTrait' => $baseDir . '/src/BankNegotiation/RandomEventsTrait.php',
    'BankNegotiationRequestsTrait' => $baseDir . '/src/BankNegotiation/RequestsTrait.php',
    'BankNegotiationService' => $baseDir . '/src/BankNegotiationService.php',
    'BankRepaymentTrait' => $baseDir . '/src/Bank/RepaymentTrait.php',
    'BankSection' => $baseDir . '/src/Tick/BankSection.php',
    'BankService' => $baseDir . '/src/BankService.php',
    'BankSettings' => $baseDir . '/src/BankSettings.php',
    'BankruptcyEventsTrait' => $baseDir . '/src/Bankruptcy/EventsTrait.php',
    'BankruptcyOptionsTrait' => $baseDir . '/src/Bankruptcy/OptionsTrait.php',
    'BankruptcyService' => $baseDir . '/src/BankruptcyService.php',
    'BankruptcyStateTrait' => $baseDir . '/src/Bankruptcy/StateTrait.php',
    'BannerSettingsFeature' => $baseDir . '/src/Privacy/Features/Banner/BannerSettingsFeature.php',
    'BannerSettingsService' => $baseDir . '/src/Privacy/Features/Banner/BannerSettingsService.php',
    'BlackMarketModule' => $baseDir . '/src/Tick/Modules/BlackMarketModule.php',
    'BlackMarketService' => $baseDir . '/src/BlackMarketService.php',
    'BoardAccess' => $baseDir . '/src/BoardAccess.php',
    'BoardColumnSkill' => $baseDir . '/src/Training/Skills/BoardColumnSkill.php',
    'BriberyConfig' => $baseDir . '/src/Bribery/BriberyConfig.php',
    'BriberyService' => $baseDir . '/src/BriberyService.php',
    'CSRF' => $baseDir . '/src/CSRF.php',
    'Cache' => $baseDir . '/src/Cache.php',
    'CandidateGenerator' => $baseDir . '/src/CandidateGenerator.php',
    'CashTransferService' => $baseDir . '/src/CashTransferService.php',
    'ChatFilter' => $baseDir . '/src/ChatFilter.php',
    'CompanyCredibilityService' => $baseDir . '/src/CompanyCredibilityService.php',
    'Composer\\InstalledVersions' => $vendorDir . '/composer/InstalledVersions.php',
    'ConsentRepository' => $baseDir . '/src/Privacy/Features/Consents/ConsentRepository.php',
    'ConsentService' => $baseDir . '/src/Privacy/Features/Consents/ConsentService.php',
    'ConsentsFeature' => $baseDir . '/src/Privacy/Features/Consents/ConsentsFeature.php',
    'ContractQueryTrait' => $baseDir . '/src/Contracts/ContractQueryTrait.php',
    'ContractReputationService' => $baseDir . '/src/ContractReputationService.php',
    'ContractSchema' => $baseDir . '/src/Contracts/ContractSchema.php',
    'ContractService' => $baseDir . '/src/ContractService.php',
    'ContractsModule' => $baseDir . '/src/Tick/Modules/ContractsModule.php',
    'CookieRepository' => $baseDir . '/src/Privacy/Features/Cookies/CookieRepository.php',
    'CookieService' => $baseDir . '/src/Privacy/Features/Cookies/CookieService.php',
    'CookiesFeature' => $baseDir . '/src/Privacy/Features/Cookies/CookiesFeature.php',
    'CredibilityModule' => $baseDir . '/src/Tick/Modules/CredibilityModule.php',
    'CredibilitySection' => $baseDir . '/src/Tick/CredibilitySection.php',
    'Database' => $baseDir . '/src/Database.php',
    'DirectorNotificationService' => $baseDir . '/src/DirectorNotificationService.php',
    'DisasterMessages' => $baseDir . '/src/DisasterMessages.php',
    'EmailTemplate' => $baseDir . '/src/EmailTemplate.php',
    'EmployeeRef' => $baseDir . '/src/Employee/EmployeeRef.php',
    'EmployeeRepository' => $baseDir . '/src/Employee/EmployeeRepository.php',
    'EmployeeStateService' => $baseDir . '/src/Employee/EmployeeStateService.php',
    'EmployeeSystemBootstrap' => $baseDir . '/src/EmployeeSystemBootstrap.php',
    'FinancePolicyService' => $baseDir . '/src/FinancePolicyService.php',
    'FinanceService' => $baseDir . '/src/FinanceService.php',
    'FinancialStateSection' => $baseDir . '/src/Tick/FinancialStateSection.php',
    'FinancialTransactionService' => $baseDir . '/src/FinancialTransactionService.php',
    'GameLog' => $baseDir . '/src/GameLog.php',
    'GameShell' => $baseDir . '/src/GameShell.php',
    'GeologicalLayerService' => $baseDir . '/src/GeologicalLayerService.php',
    'HRDataTrait' => $baseDir . '/src/HR/DataTrait.php',
    'HREventsTrait' => $baseDir . '/src/HR/EventsTrait.php',
    'HRHiringTrait' => $baseDir . '/src/HR/HiringTrait.php',
    'HRRecruitmentTrait' => $baseDir . '/src/HR/RecruitmentTrait.php',
    'HRService' => $baseDir . '/src/HRService.php',
    'HeadhunterService' => $baseDir . '/src/HeadhunterService.php',
    'HubAcquisitionService' => $baseDir . '/src/HubAcquisitionService.php',
    'HubAdminActionsTrait' => $baseDir . '/src/Hub/AdminActionsTrait.php',
    'HubAdminQueryTrait' => $baseDir . '/src/Hub/AdminQueryTrait.php',
    'HubAssignmentQueryTrait' => $baseDir . '/src/Hub/AssignmentQueryTrait.php',
    'HubAssignmentService' => $baseDir . '/src/HubAssignmentService.php',
    'HubAssignmentValidationTrait' => $baseDir . '/src/Hub/AssignmentValidationTrait.php',
    'HubConfigTrait' => $baseDir . '/src/Hub/ConfigTrait.php',
    'HubEconomyService' => $baseDir . '/src/HubEconomyService.php',
    'HubEventsTrait' => $baseDir . '/src/Hub/EventsTrait.php',
    'HubIncidentEffectsTrait' => $baseDir . '/src/Hub/IncidentEffectsTrait.php',
    'HubIncidentRiskTrait' => $baseDir . '/src/Hub/IncidentRiskTrait.php',
    'HubIncidentService' => $baseDir . '/src/HubIncidentService.php',
    'HubPlayerQueryTrait' => $baseDir . '/src/Hub/PlayerQueryTrait.php',
    'HubQueryTrait' => $baseDir . '/src/Hub/QueryTrait.php',
    'HubService' => $baseDir . '/src/HubService.php',
    'HubTickCalculationsTrait' => $baseDir . '/src/Hub/TickCalculationsTrait.php',
    'HubTickPersistTrait' => $baseDir . '/src/Hub/TickPersistTrait.php',
    'HubTickService' => $baseDir . '/src/HubTickService.php',
    'HubViewHubsTrait' => $baseDir . '/src/Hub/ViewHubsTrait.php',
    'HubViewService' => $baseDir . '/src/HubViewService.php',
    'HubViewSummaryTrait' => $baseDir . '/src/Hub/ViewSummaryTrait.php',
    'IncidentMessagesTrait' => $baseDir . '/src/Incident/MessagesTrait.php',
    'IncidentRepairDataTrait' => $baseDir . '/src/Incident/RepairDataTrait.php',
    'IncidentService' => $baseDir . '/src/IncidentService.php',
    'IncidentTickTrait' => $baseDir . '/src/Incident/TickTrait.php',
    'InterestEngine' => $baseDir . '/src/InterestEngine.php',
    'LegalBriberyTrait' => $baseDir . '/src/Legal/BriberyTrait.php',
    'LegalHubPermitTrait' => $baseDir . '/src/Legal/HubPermitTrait.php',
    'LegalModule' => $baseDir . '/src/Tick/Modules/LegalModule.php',
    'LegalSection' => $baseDir . '/src/Tick/LegalSection.php',
    'LegalService' => $baseDir . '/src/LegalService.php',
    'LoanDecisionService' => $baseDir . '/src/LoanDecisionService.php',
    'LoanRepository' => $baseDir . '/src/LoanRepository.php',
    'LogisticsService' => $baseDir . '/src/LogisticsService.php',
    'Mailer' => $baseDir . '/src/Mailer.php',
    'MarineDeliverySection' => $baseDir . '/src/Tick/MarineDeliverySection.php',
    'MarineDeliveryService' => $baseDir . '/src/MarineDeliveryService.php',
    'MarinePurgeModule' => $baseDir . '/src/Tick/Modules/MarinePurgeModule.php',
    'Market' => $baseDir . '/src/Market.php',
    'MarketModule' => $baseDir . '/src/Tick/Modules/MarketModule.php',
    'MarketOffer' => $baseDir . '/src/MarketOffer.php',
    'MarketSection' => $baseDir . '/src/Tick/MarketSection.php',
    'MarketTick' => $baseDir . '/src/MarketTick.php',
    'MarketTrend' => $baseDir . '/src/MarketTrend.php',
    'MobileWebBridge' => $baseDir . '/src/MobileWebBridge.php',
    'OfflineSection' => $baseDir . '/src/Tick/OfflineSection.php',
    'OffshoreTransportService' => $baseDir . '/src/OffshoreTransportService.php',
    'OutboundLegService' => $baseDir . '/src/OutboundLegService.php',
    'PHPMailer\\PHPMailer\\Exception' => $baseDir . '/src/PHPMailer/Exception.php',
    'PHPMailer\\PHPMailer\\PHPMailer' => $baseDir . '/src/PHPMailer/PHPMailer.php',
    'PHPMailer\\PHPMailer\\SMTP' => $baseDir . '/src/PHPMailer/SMTP.php',
    ...
    'PipelineSection' => $baseDir . '/src/Tick/PipelineSection.php',
    'Player' => $baseDir . '/src/Player.php',
    'PlayerPaymentService' => $baseDir . '/src/PlayerPaymentService.php',
    'PlayersModule' => $baseDir . '/src/Tick/Modules/PlayersModule.php',
    'PlayersSection' => $baseDir . '/src/Tick/PlayersSection.php',
    'PolicyFeature' => $baseDir . '/src/Privacy/Features/Policy/PolicyFeature.php',
    'PolicyRepository' => $baseDir . '/src/Privacy/Features/Policy/PolicyRepository.php',
    'PortSection' => $baseDir . '/src/Tick/PortSection.php',
    'PortService' => $baseDir . '/src/PortService.php',
    'PrivacyAuditLogger' => $baseDir . '/src/Privacy/PrivacyAuditLogger.php',
    'PrivacyBannerService' => $baseDir . '/src/Privacy/PrivacyBannerService.php',
    'PrivacyConsentService' => $baseDir . '/src/Privacy/PrivacyConsentService.php',
    'PrivacyFeatureInterface' => $baseDir . '/src/Privacy/PrivacyFeatureInterface.php',
    'PrivacyFeatureRegistry' => $baseDir . '/src/Privacy/PrivacyFeatureRegistry.php',
    'PrivacyPolicyService' => $baseDir . '/src/Privacy/PrivacyPolicyService.php',
    'PrivacySettingsService' => $baseDir . '/src/Privacy/PrivacySettingsService.php',
    'ProtectionSchema' => $baseDir . '/src/Protection/ProtectionSchema.php',
    'ProtectionService' => $baseDir . '/src/ProtectionService.php',
    'RateLimiter' => $baseDir . '/src/RateLimiter.php',
    'RecruitmentAPI' => $baseDir . '/src/RecruitmentAPI.php',
    'RegionalEventService' => $baseDir . '/src/RegionalEventService.php',
    'RegionalEventsTrait' => $baseDir . '/src/RegionalEvent/EventsTrait.php',
    'RegionalModifiersTrait' => $baseDir . '/src/RegionalEvent/ModifiersTrait.php',
    'RiskScoreEngine' => $baseDir . '/src/RiskScoreEngine.php',
    'RoadTransportService' => $baseDir . '/src/RoadTransportService.php',
    'SabotageSchema' => $baseDir . '/src/Sabotage/SabotageSchema.php',
    'SabotageService' => $baseDir . '/src/SabotageService.php',
    ...
    'SpillSection' => $baseDir . '/src/Tick/SpillSection.php',
    'Storage' => $baseDir . '/src/Storage.php',
    'TTSManagerTrait' => $baseDir . '/src/TTS/ManagerTrait.php',
    'TTSNotificationsTrait' => $baseDir . '/src/TTS/NotificationsTrait.php',
    'TTSProceduresTrait' => $baseDir . '/src/TTS/ProceduresTrait.php',
    'TTSRecruitmentTrait' => $baseDir . '/src/TTS/RecruitmentTrait.php',
    'TTSStaffTrait' => $baseDir . '/src/TTS/StaffTrait.php',
    'TTSTasksTrait' => $baseDir . '/src/TTS/TasksTrait.php',
    'TaskConfigService' => $baseDir . '/src/TaskConfigService.php',
    'TechnicalPageActionsTrait' => $baseDir . '/src/TechnicalPage/ActionsTrait.php',
    'TechnicalPageController' => $baseDir . '/src/TechnicalPageController.php',
    'TechnicalPageDataTrait' => $baseDir . '/src/TechnicalPage/DataTrait.php',
    'TechnicalPageRecruitmentViewTrait' => $baseDir . '/src/TechnicalPage/RecruitmentViewTrait.php',
    'TechnicalPageViewDataTrait' => $baseDir . '/src/TechnicalPage/ViewDataTrait.php',
    'TechnicalSubSkill' => $baseDir . '/src/Training/Skills/TechnicalSubSkill.php',
    'TechnicalTeamService' => $baseDir . '/src/TechnicalTeamService.php',
    ...
    'TickContext' => $baseDir . '/src/Tick/TickContext.php',
    'TickCoordinator' => $baseDir . '/src/Tick/TickCoordinator.php',
    'TickEngine' => $baseDir . '/src/Tick/TickEngine.php',
    'TickFailurePolicy' => $baseDir . '/src/Tick/TickFailurePolicy.php',
    'TickModule' => $baseDir . '/src/Tick/TickModule.php',
    'TickModuleAdminService' => $baseDir . '/src/TickModuleAdminService.php',
    'TickModuleCatalog' => $baseDir . '/src/Tick/TickModuleCatalog.php',
    'TickModuleConfigRepository' => $baseDir . '/src/Tick/TickModuleConfigRepository.php',
    'TickModuleScheduler' => $baseDir . '/src/Tick/TickModuleScheduler.php',
    'TickRegistry' => $baseDir . '/src/Tick/TickRegistry.php',
    'TickRunResult' => $baseDir . '/src/Tick/TickRunResult.php',
    'TickStatsRepository' => $baseDir . '/src/Tick/TickStatsRepository.php',
    'Totp' => $baseDir . '/src/Totp.php',
    'TrainingModule' => $baseDir . '/src/Tick/Modules/TrainingModule.php',
    'TrainingSection' => $baseDir . '/src/Tick/TrainingSection.php',
    'TrainingService' => $baseDir . '/src/Training/TrainingService.php',
    'TrainingSkillInterface' => $baseDir . '/src/Training/TrainingSkillInterface.php',
    'TrainingSkillRegistry' => $baseDir . '/src/Training/TrainingSkillRegistry.php',
    'TransportConfigService' => $baseDir . '/src/TransportConfigService.php',
    'Validator' => $baseDir . '/src/Validator.php',
    'WalletConfig' => $baseDir . '/src/WalletConfig.php',
    'WalletService' => $baseDir . '/src/WalletService.php',
    'Well' => $baseDir . '/src/Well.php',
    'WellActionsTrait' => $baseDir . '/src/Well/ActionsTrait.php',
    'WellConfigTrait' => $baseDir . '/src/Well/ConfigTrait.php',
    'WellCostsTrait' => $baseDir . '/src/Well/CostsTrait.php',
    'WellDisastersTrait' => $baseDir . '/src/Well/DisastersTrait.php',
    'WellGridData' => $baseDir . '/src/WellGridData.php',
    'WellHubSection' => $baseDir . '/src/Tick/WellHubSection.php',
    'WellLoopSection' => $baseDir . '/src/Tick/WellLoopSection.php',
    'WellPipelineService' => $baseDir . '/src/WellPipelineService.php',
    'WellProductionHandler' => $baseDir . '/src/Tick/WellProductionHandler.php',
    'WellProductionSection' => $baseDir . '/src/Tick/WellProductionSection.php',
    'WellQueryTrait' => $baseDir . '/src/Well/QueryTrait.php',
    'WellRiskHandler' => $baseDir . '/src/Tick/WellRiskHandler.php',
    'WellRoadTripSection' => $baseDir . '/src/Tick/WellRoadTripSection.php',
    'WellSellTrait' => $baseDir . '/src/Well/SellTrait.php',
    'WellService' => $baseDir . '/src/WellService.php',
    'WellShop' => $baseDir . '/src/WellShop.php',
    'WellStaffService' => $baseDir . '/src/WellStaffService.php',
    'WellStatusHandler' => $baseDir . '/src/Tick/WellStatusHandler.php',
    'WellTickTrait' => $baseDir . '/src/Well/TickTrait.php',
    'WorldMap' => $baseDir . '/src/WorldMap.php',
);
