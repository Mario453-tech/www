...
(function () {
    ...
    /*
     * confirmSubmit(el, message, opts?) — pytanie w modalu przed wyslaniem formularza.
     * el moze byc <form>, przyciskiem (uzywa el.form) lub dowolnym elementem w formularzu.
     * Uzycie:
     *   <form onsubmit="return confirmSubmit(this, 'Na pewno?')">
     *   <button onclick="confirmSubmit(this, 'Na pewno?', {type:'danger'}); return false;">
     * Zwraca false (blokuje natywne wyslanie); po potwierdzeniu wysyla formularz.
     */
    window.confirmSubmit = function (el, message, opts) {
        opts = opts || {};
 ...
 // Drugie przejscie (po potwierdzeniu) — pozwol wyslac.
 ...
 // form.submit() nie wywoluje ponownie onsubmit — brak petli.
            if (typeof form.submit === 'function') {
                form.submit();
            }
        }, {
            title: opts.title || LABELS.confirm,
