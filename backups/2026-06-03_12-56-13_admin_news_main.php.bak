...
<div class="news-admin-layout">
    ...
    <section class="panel news-form-panel">
        <p class="panel-title">
            <?= $editNews
                ? '<span class="news-form-mode news-form-mode--edit">' . t('admin.news.edit_heading') . '</span>'
        ...
        <form method="post" action="/admin/news.php" class="news-form" id="admin-news-form">
            ...
            <div class="news-field">
                <label class="news-label" for="admin-news-content"><?= t('admin.news.content_label') ?></label>
                <div class="news-editor-wrap">
                    <textarea
                        ...
                        required
                    ><?= htmlspecialchars($editNews['content'] ?? '') ?></textarea>
                </div>
            </div>
    ...
    <section class="panel news-list-panel">
        ...
        <div class="news-empty">
            <span class="news-empty-icon"><?= t('admin.news.empty_icon') ?></span>
            ...
            <article class="news-card<?= $n['is_pinned'] ? ' news-card--pinned' : '' ?>">
                ...
                <div class="news-card-footer">
                    ...
                    <div class="news-card-actions">
                        <a href="/admin/news.php?edit=<?= (int) $n['id'] ?>" class="btn btn-secondary btn-sm">
