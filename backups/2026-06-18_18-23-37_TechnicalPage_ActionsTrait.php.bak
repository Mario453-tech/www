...
trait TechnicalPageActionsTrait
{
    public function handlePost(): array
    {
        ...
        switch ($action) {
            case 'assign_task':
                [$msg, $msgType] = $this->handleAssignTask();
                break;
            case 'fire_engineer':
                [$msg, $msgType] = $this->handleFireEngineer();
                break;
            case 'review_candidate':
                [$msg, $msgType] = $this->handleReviewCandidate();
                break;
            ...
            case 'cancel_recruitment':
                ...
                break;
            case 'cancel_task':
                [$msg, $msgType] = $this->handleCancelTask();
                break;
            ...
            case 'repair_procedure_integrity':
                [$msg, $msgType] = $this->handleRepairProcedureIntegrity();
                break;
 ...
 // Zadania AJAX (X-Requested-With) dostaja JSON i modal po stronie klienta,
 // zamiast przeladowania strony z bialym paskiem komunikatu.
        if (
