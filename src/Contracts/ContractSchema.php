...
class ContractSchema
{
    ...
    private static function migrateMysql(PDO $db): void
    {
        try {
            ...
            Database::addColumnIfMissing('player_contracts', 'renegotiations_used', "INT NOT NULL DEFAULT 0");
            Database::addColumnIfMissing('player_contracts', 'last_renegotiated_at', "DATETIME NULL");
    ...
    private static function createSqlite(PDO $db): void
    {
        ...
        self::sqliteAddColumnIfMissing($db, 'player_contracts', 'renegotiations_used', "INTEGER NOT NULL DEFAULT 0");
        self::sqliteAddColumnIfMissing($db, 'player_contracts', 'last_renegotiated_at', "TEXT NULL");
        $db->exec(
            "CREATE TABLE IF NOT EXISTS contract_deliveries (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
