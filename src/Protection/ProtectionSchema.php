...
class ProtectionSchema
{
    ...
    public static function ensure(PDO $db): void
    {
        ...
        try {
            ...
            // Cache oznaczamy jako sukces dopiero po udanym DDL.
            // Mark ensured only after successful DDL so a failed first call can retry.
    ...
    private static function seedDefaults(PDO $db, string $driver): void
    {
        $options = [
            [
                ...
                'target_type' => 'road_transport', 'context' => 'road_transport_guard',
            ...
            [
                'code' => 'hub_security',
                'name' => 'Ochrona huba',
                'description' => 'Obstawa i serwis prewencyjny huba. Zmniejsza ryzyko uszkodzenia sprzętu, wycieku i krytycznego przeciążenia.',
                'target_type' => 'hub', 'context' => 'hub_guard',
                'cost_type' => 'fixed', 'cost_value' => 120000.00,
                'duration_minutes' => 60, 'min_legal_level' => 0, 'sort_order' => 40,
                'effects' => ['equipment_damage_risk_mult' => 0.75, 'critical_overload_risk_mult' => 0.70, 'local_leak_risk_mult' => 0.85],
            ],
            [
                'code' => 'pipeline_monitor',
                'name' => 'Monitoring rurociągu',
                'description' => 'Stały nadzór i czujniki ciśnienia na rurociągu. Zmniejsza ryzyko awarii tego odcinka.',
                'target_type' => 'pipeline', 'context' => 'pipeline_guard',
                'cost_type' => 'per_hour', 'cost_value' => 30000.00,
                'duration_minutes' => 120, 'min_legal_level' => 0, 'sort_order' => 50,
                'effects' => ['pipeline_incident_risk_mult' => 0.75],
            ],
        ];
