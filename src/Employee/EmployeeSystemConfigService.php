...
final class EmployeeSystemConfigService
{
    ...
    private const DEFINITIONS = [
        ...
        'leave_risk_threshold' => ['type'=>'float','min'=>50,'max'=>100,'step'=>1,'default'=>90.0,'group'=>'relations','label_key'=>'admin.hr.config.leave_risk_threshold','description_key'=>'admin.hr.config.leave_risk_threshold_desc'],
        'leave_risk_cycles_required' => ['type'=>'int','min'=>1,'max'=>20,'step'=>1,'default'=>3,'group'=>'relations','label_key'=>'admin.hr.config.leave_risk_cycles','description_key'=>'admin.hr.config.leave_risk_cycles_desc'],
        'leave_notice_hours' => ['type'=>'int','min'=>1,'max'=>720,'step'=>1,'default'=>48,'group'=>'relations','label_key'=>'admin.hr.config.leave_notice_hours','description_key'=>'admin.hr.config.leave_notice_hours_desc'],
        ...
        'raise_accept_morale_gain' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>20.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_accept_morale_gain','description_key'=>'admin.hr.config.raise_accept_morale_gain_desc'],
        'raise_accept_loyalty_gain' => ['type'=>'float','min'=>0,'max'=>10,'step'=>1,'default'=>5.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_accept_loyalty_gain','description_key'=>'admin.hr.config.raise_accept_loyalty_gain_desc'],
        'raise_accept_leave_risk_reduction' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>15.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_accept_leave_risk_reduction','description_key'=>'admin.hr.config.raise_accept_leave_risk_reduction_desc'],
        'raise_salary_negotiator_chance_bonus' => ['type'=>'float','min'=>0,'max'=>50,'step'=>1,'default'=>10.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_salary_negotiator_chance_bonus','description_key'=>'admin.hr.config.raise_salary_negotiator_chance_bonus_desc'],
        'raise_negotiated_morale_gain' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>8.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_negotiated_morale_gain','description_key'=>'admin.hr.config.raise_negotiated_morale_gain_desc'],
        'raise_negotiation_fail_morale_penalty' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>5.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_negotiation_fail_morale_penalty','description_key'=>'admin.hr.config.raise_negotiation_fail_morale_penalty_desc'],
        'raise_reject_morale_penalty' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>20.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_reject_morale_penalty','description_key'=>'admin.hr.config.raise_reject_morale_penalty_desc'],
        'raise_reject_support_gain' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>15.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_reject_support_gain','description_key'=>'admin.hr.config.raise_reject_support_gain_desc'],
        'raise_reject_leave_risk_gain' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>15.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_reject_leave_risk_gain','description_key'=>'admin.hr.config.raise_reject_leave_risk_gain_desc'],
        'raise_postpone_morale_penalty' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>5.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_postpone_morale_penalty','description_key'=>'admin.hr.config.raise_postpone_morale_penalty_desc'],
        'raise_postpone_leave_risk_gain' => ['type'=>'float','min'=>0,'max'=>100,'step'=>1,'default'=>5.0,'group'=>'relations','label_key'=>'admin.hr.config.raise_postpone_leave_risk_gain','description_key'=>'admin.hr.config.raise_postpone_leave_risk_gain_desc'],
        'raise_postpone_hours' => ['type'=>'int','min'=>1,'max'=>720,'step'=>1,'default'=>24,'group'=>'relations','label_key'=>'admin.hr.config.raise_postpone_hours','description_key'=>'admin.hr.config.raise_postpone_hours_desc'],
        'raise_max_postponements' => ['type'=>'int','min'=>0,'max'=>10,'step'=>1,'default'=>1,'group'=>'relations','label_key'=>'admin.hr.config.raise_max_postponements','description_key'=>'admin.hr.config.raise_max_postponements_desc'],
        ...
        'strike_logistics_capacity_cap' => ['type'=>'float','min'=>0.1,'max'=>1,'step'=>0.05,'default'=>0.70,'group'=>'effects','label_key'=>'admin.hr.config.strike_logistics_capacity_cap','description_key'=>'admin.hr.config.strike_logistics_capacity_cap_desc'],
        'strike_road_cost_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.20,'group'=>'effects','label_key'=>'admin.hr.config.strike_road_cost_multiplier','description_key'=>'admin.hr.config.strike_road_cost_multiplier_desc'],
        'strike_road_delay_risk_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.15,'group'=>'effects','label_key'=>'admin.hr.config.strike_road_delay_risk_multiplier','description_key'=>'admin.hr.config.strike_road_delay_risk_multiplier_desc'],
        'strike_logistics_response_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.25,'group'=>'effects','label_key'=>'admin.hr.config.strike_logistics_response_multiplier','description_key'=>'admin.hr.config.strike_logistics_response_multiplier_desc'],
        'strike_technical_repair_time_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.40,'group'=>'effects','label_key'=>'admin.hr.config.strike_technical_repair_time_multiplier','description_key'=>'admin.hr.config.strike_technical_repair_time_multiplier_desc'],
        'strike_technical_emergency_cost_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.15,'group'=>'effects','label_key'=>'admin.hr.config.strike_technical_emergency_cost_multiplier','description_key'=>'admin.hr.config.strike_technical_emergency_cost_multiplier_desc'],
        'strike_hr_recruitment_time_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.25,'group'=>'effects','label_key'=>'admin.hr.config.strike_hr_recruitment_time_multiplier','description_key'=>'admin.hr.config.strike_hr_recruitment_time_multiplier_desc'],
        'strike_hr_negotiation_effectiveness' => ['type'=>'float','min'=>0.1,'max'=>1,'step'=>0.05,'default'=>0.80,'group'=>'effects','label_key'=>'admin.hr.config.strike_hr_negotiation_effectiveness','description_key'=>'admin.hr.config.strike_hr_negotiation_effectiveness_desc'],
        'strike_legal_case_time_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.25,'group'=>'effects','label_key'=>'admin.hr.config.strike_legal_case_time_multiplier','description_key'=>'admin.hr.config.strike_legal_case_time_multiplier_desc'],
        'strike_legal_effectiveness' => ['type'=>'float','min'=>0.1,'max'=>1,'step'=>0.05,'default'=>0.85,'group'=>'effects','label_key'=>'admin.hr.config.strike_legal_effectiveness','description_key'=>'admin.hr.config.strike_legal_effectiveness_desc'],
        'strike_legal_deadline_risk_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.15,'group'=>'effects','label_key'=>'admin.hr.config.strike_legal_deadline_risk_multiplier','description_key'=>'admin.hr.config.strike_legal_deadline_risk_multiplier_desc'],
        'strike_hr_negative_morale_multiplier' => ['type'=>'float','min'=>1,'max'=>3,'step'=>0.05,'default'=>1.15,'group'=>'effects','label_key'=>'admin.hr.config.strike_hr_negative_morale_multiplier','description_key'=>'admin.hr.config.strike_hr_negative_morale_multiplier_desc'],
    ];
