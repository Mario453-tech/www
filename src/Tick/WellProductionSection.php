 ...
 */
 ...
 // 'servicing' = odwiert w naprawie przez serwisanta: zamrozony (brak produkcji,
 // incydentow, degradacji i OPEX) az do zakonczenia zadania technicznego.
 // 'servicing' = well under technician service: frozen (no production, incidents,
 // degradation or OPEX) until the technical task completes.
        if (in_array($well['status'], ['seized', 'blowout', 'broken', 'servicing'])) return;
