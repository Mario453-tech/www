 ...
 */
 ...
 // No hub - immediate fallback cap (well without infrastructure).
            ...
            // loss_mult dotyczy strat losowych (wycieki, incydenty), nie fizycznego limitu przepustowosci.
            // loss_mult applies to random losses (leaks, incidents), NOT the hard physical throughput cap.
