...
class FinancialTransactionService
{
    ...
    public function debitCombined(
        ...
        try {
            ...
            // floor() zamiast round() — zapobiega przekroczeniu rzeczywistego salda po zaokragleniu.
            // floor() instead of round() — prevents fromBank exceeding actual balance after rounding.
            $fromBank = floor(min($bankBalance, $amount) * 100.0) / 100.0;
