...
--
-- Struktura tabeli dla tabeli `market_sale_history`
--

CREATE TABLE `market_sale_history` (
  `id` int NOT NULL,
  `player_id` int NOT NULL,
  `offer_id` int NOT NULL,
...
--
-- Dumping data for table `market_sale_history`
--
...
CREATE TABLE `technical_staff` (
  ...
  `trait_loyalty` tinyint UNSIGNED NOT NULL DEFAULT '5',
  `trait_corruption_risk` tinyint UNSIGNED NOT NULL DEFAULT '5',
  `trait_ambition` tinyint UNSIGNED NOT NULL DEFAULT '5',
...
CREATE TABLE `technical_tasks` (
  ...
  `pipeline_id` int UNSIGNED DEFAULT NULL COMMENT 'well_pipelines.id (zadania rurociągowe)',
...
CREATE TABLE `wells` (
  ...
  `status` enum('active','paused_storage','paused_cash','paused_staff','no_operator','no_technician','broken','blowout','contaminated','seized','layer_switch','sold','equipment_swap','servicing') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active',
  `service_prev_status` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Status sprzed serwisu (przywracany po zakończeniu zadania)',
  ...
  `technical_condition` decimal(5,1) NOT NULL DEFAULT '100.0',
  `well_type` enum('onshore','offshore') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'onshore',
  ...
  `ticks_since_incident` int NOT NULL DEFAULT '0',
...
CREATE TABLE `well_pipelines` (
  ...
  `status` enum('active','degraded','critical','damaged','disabled','building','leak','suspended','servicing') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `service_prev_status` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Status sprzed serwisu rurociągu',
  `condition_pct` decimal(8,4) NOT NULL DEFAULT '100.0000',
...
--
-- Indeksy dla tabeli `market_sale_history`
--
ALTER TABLE `market_sale_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_player_sold` (`player_id`,`sold_at`);
...
--
-- AUTO_INCREMENT for table `market_sale_history`
--
ALTER TABLE `market_sale_history`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
