    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th title="<?= t('admin.legal.col_delay_pct_hint') ?>"><?= t('admin.legal.col_delay_pct') ?></th>
                <th><?= t('admin.legal.col_delay_min') ?></th>
                <th><?= t('admin.legal.col_delay_max') ?></th>
                <th title="<?= t('admin.legal.col_refusal_pct_hint') ?>"><?= t('admin.legal.col_refusal_pct') ?></th>
                <th title="<?= t('admin.legal.col_nodec_pct_hint') ?>"><?= t('admin.legal.col_nodec_pct') ?></th>
                <th><?= t('admin.legal.col_cooldown') ?></th>
                <th><?= t('admin.legal.col_capital') ?></th>
                <!-- P2a: hub permit columns / Kolumny zezwolen na huby -->
                <th title="<?= t('admin.legal.hub.col_enabled_hint') ?>"><?= t('admin.legal.hub.col_enabled') ?></th>
        ...
        <tr>
            ...
            <td><input type="number" name="delay_min_minutes"       value="<?= (int)$cfg['delay_min_minutes'] ?>"        min="0" step="5"  class="input-sm" style="width:60px"></td>
            <td><input type="number" name="delay_max_minutes"       value="<?= (int)$cfg['delay_max_minutes'] ?>"        min="0" step="5"  class="input-sm" style="width:60px"></td>
            ...
            <td><input type="number"   name="hub_permit_cost"    value="<?= (float)($cfg['hub_permit_cost'] ?? 500000) ?>" min="0" step="10000" class="input-sm" style="width:110px"></td>
            <td><input type="number"   name="hub_review_minutes" value="<?= (int)($cfg['hub_review_minutes'] ?? 120) ?>"   min="1" step="5"      class="input-sm" style="width:70px"></td>
