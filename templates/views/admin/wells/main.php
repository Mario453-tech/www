    ...
    <div class="data-list">
        ...
        <div class="aw-gm-panel" id="aw-form-<?= $wId ?>" style="display:none">
            ...
            <form method="POST" class="aw-quick-restore">
                ...
                <span class="aw-quick-restore-arrow">→</span>
                <input type="number" name="technical_condition" min="0" max="100" value="<?= $cond ?>" required>
                <span class="aw-quick-restore-unit">%</span>
                <button type="submit" class="btn-restore"><?= t('admin.wells.quick_restore_btn') ?></button>
            </form>
                ...
                <div class="aw-gm-sections">
                        ...
                        <div class="aw-gm-fields">
                            <div class="aw-field">
                                ...
                                <select name="status" class="aw-select">
                                    <?php foreach (['active','paused_storage','paused_cash','paused_staff','no_operator','no_technician','broken','blowout','contaminated','seized','layer_switch','sold','servicing'] as $sv): ?>
                    ...
                    <div class="aw-gm-section">
                        ...
                        <div class="aw-gm-fields">
                            ...
                            <?php $outboundTransport = (string)($w['hub_outbound_transport_type'] ?? 'nieustawiony'); ?>
                            <div class="aw-field">
                                <label><?= t('admin.wells.gm_field_outbound_transport_type') ?></label>
                                <select name="hub_outbound_transport_type" class="aw-select">
                                    <?php foreach (['nieustawiony','rurociag','ciezarowki','tankowiec'] as $ot): ?>
                                    <option value="<?= $ot ?>"<?= $outboundTransport === $ot ? ' selected' : '' ?>><?= t('admin.wells.transport.' . $ot) ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                            <div class="aw-field">
