...
<div class="admin-content">
    ...
    <section class="hr-section">
        <div class="section-toolbar">
            ...
            <form method="post" onsubmit="return confirm('<?= t('admin.hr.confirm_cleanup') ?>')">
            ...
            <details class="spec-card">
                ...
                <form method="post" id="del-spec-<?= htmlspecialchars($spec['code']) ?>" class="spec-delete-form">
                    ...
                    <button type="button" class="btn btn-sm btn-danger"
                        onclick="confirmAction('<?= t('admin.hr.confirm_delete_spec') ?> (<?= htmlspecialchars($spec['code']) ?>)?',function(){document.getElementById('del-spec-<?= htmlspecialchars($spec['code']) ?>').submit();},{type:'danger',confirmLabel:'<?= t('common.delete') ?>'})">
                        <?= t('common.delete') ?>
                    </button>
                </form>
            </details>
        ...
        <div class="data-list hr-hrspecs-grid">
            ...
            <div class="spec-group-inline">
                ...
                <article class="list-row" role="row">
                    ...
                    <span>
                        <button type="button" class="btn btn-sm btn-danger"
                            onclick="confirmAction('<?= t('admin.hr.confirm_delete_spec') ?>',function(){document.getElementById('del-hs-<?= (int)$hs['id'] ?>').submit();},{type:'danger',confirmLabel:'<?= t('common.delete') ?>'})">
                            <?= t('common.delete') ?>
                        </button>
                    </span>
                </article>
