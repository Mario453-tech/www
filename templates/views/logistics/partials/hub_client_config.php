...
$logisticsClientConfig['staffing'] = [
    ...
    'operator_not_configured' => t('logistics.hub.staffing.operator_not_configured'),
    'recruit_operator' => t('logistics.hub.staffing.recruit_operator'),
    'recruit_url' => (function_exists('url') ? url('technical') : '/technical') . '?tab=candidates#technical-recruitment-hub_operator',
