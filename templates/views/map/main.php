...
<div class="map-layout">
    ...
    <aside class="map-sidebar" id="map-sidebar">
        ...
        <div class="sidebar-region" id="sidebar-region" style="display:none">
            ...
            <!-- Brief §6.1: baner statusu zezwolenia (np. "Masz aktywne zezwolenie..."). -->
            <!-- Brief §6.1: permit status banner (e.g. "You have an active permit..."). -->
            <div class="sr-permit" id="sr-permit" style="display:none"></div>
...
window.MAP_LANG = <?= json_encode([
    ...
    'permit_required_title'   => t('map_js.permit_required_title'),
    'permit_required_text'    => t('map_js.permit_required_text'),
    'permit_required_unlocks' => t('map_js.permit_required_unlocks'),
    'permit_type_label'       => t('map_js.permit_type_label'),
    'permit_type_drilling'    => t('map_js.permit_type_drilling'),
    'permit_required_btn'     => t('map_js.permit_required_btn'),
    'permit_cancel_btn'       => t('map_js.permit_cancel_btn'),
    'badge_permit'            => t('map_js.badge_permit'),
    'permit_pending_title'        => t('map_js.permit_pending_title'),
    'permit_pending_text'         => t('map_js.permit_pending_text'),
    'permit_pending_text_unknown' => t('map_js.permit_pending_text_unknown'),
    'badge_permit_pending'        => t('map_js.badge_permit_pending'),
    'permit_no_decision_title'    => t('map_js.permit_no_decision_title'),
    'permit_no_decision_text'     => t('map_js.permit_no_decision_text'),
    'badge_permit_no_decision'    => t('map_js.badge_permit_no_decision'),
    'permit_refused_title'        => t('map_js.permit_refused_title'),
    'permit_refused_text'         => t('map_js.permit_refused_text'),
    'permit_refused_cooldown'     => t('map_js.permit_refused_cooldown'),
    'badge_permit_refused'        => t('map_js.badge_permit_refused'),
    'permit_locked_title'         => t('map_js.permit_locked_title'),
    'permit_locked_text'          => t('map_js.permit_locked_text'),
    'permit_locked_capital'       => t('map_js.permit_locked_capital'),
    'badge_permit_locked'         => t('map_js.badge_permit_locked'),
    'permit_legal_locked_title'   => t('map_js.permit_legal_locked_title'),
    'permit_legal_locked_text'    => t('map_js.permit_legal_locked_text'),
    'permit_legal_locked_level'   => t('map_js.permit_legal_locked_level'),
    'badge_permit_legal_locked'   => t('map_js.badge_permit_legal_locked'),
    'permit_credibility_locked_title' => t('map_js.permit_credibility_locked_title'),
    'permit_credibility_locked_text'  => t('map_js.permit_credibility_locked_text'),
    'permit_credibility_locked_level' => t('map_js.permit_credibility_locked_level'),
    'badge_permit_credibility_locked' => t('map_js.badge_permit_credibility_locked'),
    'permit_btn_go_legal'         => t('map_js.permit_btn_go_legal'),
    'permit_btn_close'            => t('map_js.permit_btn_close'),
    'permit_active_banner'        => t('map_js.permit_active_banner'),
