...
<div class="g-card">
    ...
    <div class="fin-well-list">
        ...
        foreach ($perWell as $w2) {
            $g2 = (float)$w2['base_production_per_hour'] * $oilPrice;
            $n2 = $g2 - (float)$w2['upkeep_cost_per_hour'] - $g2 * ((float)$w2['transport_opex_pct'] / 100) - $g2 * (float)$w2['regional_tax_rate'];
